...
df = pd.read_csv('final_merged_numberslstm2.csv')  # Replace 'your_dataset.csv' with the actual filename
...
# Train the model
model.fit(input_sequences, succeeding_sequences, epochs=500, verbose=2)


#Save Model
model.save("notegenerationlstmmodel.keras")